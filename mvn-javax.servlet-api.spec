...
cp %{SOURCE0} %{buildroot}/usr/share/java/.m2/repository/javax/servlet/javax.servlet-api/3.1.0

mkdir -p %{buildroot}/usr/share/java/.m2/repository/javax/servlet/javax.servlet-api/3.1.0
cp %{SOURCE1} %{buildroot}/usr/share/java/.m2/repository/javax/servlet/javax.servlet-api/3.1.0
